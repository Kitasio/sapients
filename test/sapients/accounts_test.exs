defmodule Sapients.AccountsTest do
  ...
  describe "invite_tokens" do
    ...
    test "list_invite_tokens/0 returns all invite_tokens" do
      token = token_fixture()
      assert Accounts.list_invite_tokens() == [token]
    end
    ...
    test "create_token/1 with valid data creates a token" do
      valid_attrs = %{token: "7488a646-e31f-11e4-aace-600308960662", used: true}

      assert {:ok, %Token{} = token} = Accounts.create_token(valid_attrs)
      assert token.token == "7488a646-e31f-11e4-aace-600308960662"
    ...
    test "update_token/2 with valid data updates the token" do
      ...
      assert token.token == "7488a646-e31f-11e4-aace-600308960668"
