defmodule Sapients.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Sapients.Repo)
  ...
  """
  def valid_password?(%Sapients.Accounts.User{hashed_password: hashed_password}, password)
