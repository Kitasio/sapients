defmodule SapientsWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {SapientsWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: SapientsWeb.Telemetry
    end
  end
